 ...
 */
ALAPI ALvoid	ALAPIENTRY alGenEnvironmentIASIG( ALsizei n, ALuint* environs );
ALAPI ALvoid	ALAPIENTRY alDeleteEnvironmentIASIG( ALsizei n, ALuint* environs );
ALAPI ALboolean ALAPIENTRY alIsEnvironmentIASIG( ALuint environment );
ALAPI ALvoid	ALAPIENTRY alEnvironmentiIASIG( ALuint environment, ALenum param, ALint value );
ALAPI ALvoid	ALAPIENTRY alEnvironmentfIASIG( ALuint environment, ALenum param, ALfloat value );
ALAPI ALvoid	ALAPIENTRY alGetEnvironmentiIASIG( ALuint environment, ALenum param, ALint* value );
ALAPI ALvoid	ALAPIENTRY alGetEnvironmentfIASIG( ALuint environment, ALenum param, ALfloat* value );
